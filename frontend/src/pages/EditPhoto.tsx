...
export const EditPhoto = () => {
	...
	if (loading) {
		return (
			<div className="flex items-center justify-center py-32 text-gray-400">Loading photo…</div>
		);
	}
	...
	return (
		<div className="w-full mx-auto">
			...
			<div className="flex items-center gap-3 mb-8">
				...
				<div>
					<h1 className="text-xl font-semibold text-gray-900">Edit photo</h1>
					<p className="text-sm text-gray-500 mt-0.5">Update your photo's details</p>
				</div>
			</div>
